...
template<>
inline void BrokerStats::onEvent<BrokerStats::EventType::Enum::e_CLIENT_CREATED>() {
...
template<>
inline void BrokerStats::onEvent<BrokerStats::EventType::Enum::e_CLIENT_DESTROYED>() {
    BSLS_ASSERT_SAFE(d_statContext_p && "initialize was not called");
...
template<>
inline void BrokerStats::onEvent<BrokerStats::EventType::Enum::e_QUEUE_CREATED>() {
    BSLS_ASSERT_SAFE(d_statContext_p && "initialize was not called");
...
template<>
inline void BrokerStats::onEvent<BrokerStats::EventType::Enum::e_QUEUE_DESTROYED>() {
    BSLS_ASSERT_SAFE(d_statContext_p && "initialize was not called");
